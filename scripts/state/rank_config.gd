...
@export var much_better_wax_ratio: float = 0.20
@export var lesser_opponent_win_multiplier: float = 0.50
@export var better_opponent_win_multiplier: float = 1.30
@export var much_better_opponent_win_multiplier: float = 1.60
@export var much_better_loser_loss_multiplier: float = 1.50
@export var much_worse_loser_loss_multiplier: float = 0.50
@export var close_loss_final_minute_ms: int = 60000
@export var close_loss_vs_much_better_wax: float = 1.0
@export var overtime_loss_vs_much_better_wax: float = 2.0
