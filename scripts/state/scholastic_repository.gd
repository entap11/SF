...
var sfu_tournaments_by_id: Dictionary = {}
...
func load_snapshot(snapshot: Dictionary) -> void:
	...
	sfu_tournaments_by_id = (snapshot.get("sfu_tournaments_by_id", {}) as Dictionary).duplicate(true)
...
func to_snapshot() -> Dictionary:
	return {
		...
		"sfu_tournaments_by_id": sfu_tournaments_by_id.duplicate(true)
	}
...
func put_sfu_tournament(tournament_id: String, tournament: Dictionary) -> void:
	sfu_tournaments_by_id[tournament_id] = tournament.duplicate(true)
