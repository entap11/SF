...
@export var earn_path_buttons_enabled: bool = true
...
@export var stake_bps: int = 500
@export var burn_bps: int = 1000
...
@export var standard_pvp_win_earn_millis: int = 250
@export var standard_pvp_loss_earn_millis: int = 100
@export var tournament_placement_earn_millis: int = 1000
@export var challenge_earn_millis: int = 500
@export var event_earn_millis: int = 500
