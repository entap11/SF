...
SMOKES=(
  ...
  "res://tools/rank_identity_bootstrap_bypasses_feature_gate_smoke_test.gd"
  "res://tools/rank_authoritative_registration_required_smoke_test.gd"
  "res://tools/onboarding_backend_identity_success_smoke_test.gd"
