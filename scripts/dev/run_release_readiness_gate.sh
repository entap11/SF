...
SOAK_LAUNCH_CONTRACT_TIMEOUT_SECONDS="${RELEASE_READINESS_SOAK_LAUNCH_CONTRACT_TIMEOUT_SECONDS:-60}"
...
Environment overrides:
  ...
  RELEASE_READINESS_SOAK_LAUNCH_CONTRACT_TIMEOUT_SECONDS
...
run_stage soak_launch_contract "${SOAK_LAUNCH_CONTRACT_TIMEOUT_SECONDS}" \
  "${GODOT_BIN}" --headless --path "${ROOT_DIR}" --script "${SOAK_LAUNCH_CONTRACT}"
