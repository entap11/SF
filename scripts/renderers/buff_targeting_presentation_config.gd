...
const DRAG_OVERLAY_SIZE_UI_PX: Vector2 = Vector2(64.0, 64.0)
...
const HIVE_ELIGIBLE_RING_PAD_ROOT_SCREEN_PX: float = 10.0
const HIVE_PREVIEW_RING_PAD_ROOT_SCREEN_PX: float = 18.0
const HIVE_ELIGIBLE_RING_WIDTH_ROOT_SCREEN_PX: float = 3.5
const HIVE_PREVIEW_RING_WIDTH_ROOT_SCREEN_PX: float = 5.5
...
const LANE_ELIGIBLE_WIDTH_LOCAL_PX: float = 7.0
const LANE_PREVIEW_WIDTH_LOCAL_PX: float = 16.0
const LANE_PREVIEW_BACKDROP_WIDTH_LOCAL_PX: float = 20.0
const LANE_TRAVEL_PERIOD_LOCAL_PX: float = 54.0
const LANE_TRAVEL_LENGTH_LOCAL_PX: float = 19.0
const GLOBAL_BOUNDARY_WIDTH_LOCAL_PX: float = 6.0
