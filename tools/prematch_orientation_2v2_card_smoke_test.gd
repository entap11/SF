...
const MAP_2V2_SOURCE: String = "res://maps/_future/quadfight/MAP_quadfight__SBASE__2p.json"
...
func _run() -> void:
	...
	_expect(records_panel == null or not records_panel.visible, "Redundant 2v2 prematch facts card should stay hidden", {})
