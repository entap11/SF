...
export function generateShareAssetPaths(matchId, replayId, surface, config = defaultHighlightConfig) {
...
export function buildOgImageMetadata(payload) {
    return {
...
export function renderHighlightCard(payload, surface, config = defaultHighlightConfig) {
