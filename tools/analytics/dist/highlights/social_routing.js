...
function tierDestinations(payload, config) {
...
export function buildPostingDestinations(payload, config = defaultHighlightConfig) {
    return tierDestinations(payload, config);
}
export function buildSocialJobs(payload, config = defaultHighlightConfig) {
