...
function matchDescriptor(payload) {
...
function headlineTitle(badgeKey, fallback) {
    switch (badgeKey) {
...
export function buildShareStory(payload, config = defaultHighlightConfig) {
    ...
    const storyStat = payload.analytics.comeback_factor.score_raw >= 0.82
