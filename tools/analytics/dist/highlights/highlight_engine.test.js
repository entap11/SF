...
import { asyncNoPostFixture, fourPlayerChaosFixture, majorComebackMoneyMatchFixture, tooManyBadgesFixture } from "./fixtures.js";
...
const swarmBand = computeSwarmDensityBand(moneyPayload.match.mode, moneyPayload.match.player_count, moneyPayload.match.swarms_sent_total, moneyPayload.match.duration_seconds);
...
assert.deepEqual(tooManyPayload.derived_badges.selected_badges.map((badge) => badge.badge_key), ["game_of_the_day_candidate", "wins_500"]);
const chaosPayload = buildHighlightPayload(fourPlayerChaosFixture);
assertIncludes(chaosPayload.derived_badges.candidate_badges.map((badge) => badge.badge_key), "full_chaos_match", "4-player chaos fixture should derive chaos badge");
