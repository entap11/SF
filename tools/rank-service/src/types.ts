...
export interface RankRuntimeConfig {
  ...
  lossScale: number;
  freePvpWinWax: number;
  freePvpLossWax: number;
  moneyPvpTier1WinWax: number;
  moneyPvpTier1LossWax: number;
  moneyPvpTier2WinWax: number;
  moneyPvpTier2LossWax: number;
  moneyPvpTier3WinWax: number;
  moneyPvpTier3LossWax: number;
  smallContestFirstWax: number;
  smallContestSecondWax: number;
  smallContestThirdWax: number;
  dailyContestFirstWax: number;
  dailyContestSecondWax: number;
  dailyContestThirdWax: number;
  weeklyContestFirstWax: number;
  weeklyContestSecondWax: number;
  weeklyContestThirdWax: number;
  monthlyContestFirstWax: number;
  monthlyContestSecondWax: number;
  monthlyContestThirdWax: number;
