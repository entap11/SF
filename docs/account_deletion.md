...
September 18, 2026. Implementation contract and operator runbook. See
`release_acceptance_0_1_2_2026_09_18.md` for the current certification deployment,
verified results, and remaining physical-device and fulfillment work.
